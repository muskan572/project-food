...
export default function Work({meals, cursor_pointer, delivery_truck}){
    ...
    return(
        ...
        <p className="pt-6">Lorem ipsum dolor sit amet consectetur.
             Maecenas orci et sagittis duis elementum
              interdum facilisi bibendum.</p>
        </div>

        <div className="bg-stone-200 m-10 p-6 w-[18%] rounded-xl hover:shadow-2xl">
        <img src={cursor_pointer}/>
        <h1 className="text-stone-600 text-xl font-semibold">Choose How often</h1>
        <p className="pt-6">Lorem ipsum dolor sit amet consectetur.
             Maecenas orci et sagittis duis elementum
              interdum facilisi bibendum.</p>
        </div>
        ...
        <div className="bg-stone-200 m-10 p-6 w-[18%] rounded-xl hover:shadow-2xl">
        <img src={delivery_truck}/>
        <h1 className="text-stone-600 text-xl font-semibold">Fast Deliveries</h1>
        <p className="pt-6">Lorem ipsum dolor sit amet consectetur.
             Maecenas orci et sagittis duis elementum
              interdum facilisi bibendum.</p>
        </div>
